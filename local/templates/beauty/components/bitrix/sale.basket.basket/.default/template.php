...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<main id="basket-root" class="cart margin-block">
      <div class="mycontainer">
        <h1 class="h1title">Корзина</h1>
          <section class="cart">
		<?
		if (
        ...
        <ul class="cart__list" id="basket-item-table"></ul>
		<?
		if (
			$arParams['BASKET_WITH_ORDER_INTEGRATION'] !== 'Y'
		...
		{
			?>
          <div class="ordering__wrap" data-entity="basket-total-block">
