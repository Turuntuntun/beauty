...
else
{
	...
	?>
        <main class="ordering margin-block">
          <div class="mycontainer">
            <h1 class="h1title">Оформление</h1>
            <div class="ordering__content">
	<form class="ordering__form" action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		<?
