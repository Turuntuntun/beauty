<?php
$MESS['MAIN_AUTH_PWD_SUCCESS'] = 'Мы выслали на ваш email временный пароль';
...
$MESS['MAIN_AUTH_PWD_TITLE'] = 'Восстановление пароля';
$MESS['MAIN_AUTH_PWD_DESCRIPTION'] = 'Введите email указанный вами при регистрации. Инструкция по смене пароля придёт на ваш почтовый ящик';
$MESS['MAIN_AUTH_BACK'] = 'Назад';