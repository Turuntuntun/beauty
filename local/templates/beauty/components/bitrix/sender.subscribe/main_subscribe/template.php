...
?>
<div class="footer-col"  id="sender-subscribe">
<?
...
?>
	...
	<form id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>" class="footer-subscribe">
		<?=bitrix_sessid_post()?>
        ...
        <button class="btn-background" id="bx_subscribe_btn_<?=$buttonId?>">
...
$frame->end();
?>
    <div class="footer__email">Наша почта: <a href="mailto:admin@beatu-guard.ru"><?=COption::GetOptionString('main','email_from');?></a></div>
</div>