...
?>
        <form class = 'filter' name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smart-filter-form">
            ...
            <?endforeach;?>
                <?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
                {
                    ...
                    if(isset($arItem["PRICE"])):
                        ...
                        <div class="filter-category">
                            <div class="filter-category__title accordion active"><?=$arItem["NAME"]?></div>
                            <div class="filter-category-content filter-category-price active">
                                <div class="filter-category-inverse">
                                    <label><span>от</span>
                                        <input
                ...
                foreach($arResult["ITEMS"] as $key=>$arItem)
                {
                    ...
                    ?>
                        ...
                        <div class="filter-category" data-role="bx_filter_block">
