                ...
                <? foreach ($arResult['ITEMS'] as $key => $arItem) :?>
                    ...
                    <div class="cards-item-wrap swiper-slide">
                        <div class="cards-item">
                            ...
                            <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="cards-item__img">
                                <img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="<?=$arItem['NAME']?>">
                            </a>
                            <div class="cards-item__title"><?=$arItem['NAME']?></div>
                            <div class="cards-item-bot">
                                <div class="cards-item-bot__price"><?=$arItem['PRICES']['BASE']['PRINT_VALUE']?>
                                </div>
                                <div class="cards-item-bot__btn btn-background">
                                    <a href="<?=$arItem['ADD_URL']?>">В корзину </a>
                                </div>
                            </div>
                        </div>
                    </div>
